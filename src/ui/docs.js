...
const GROUP_META = {
  ...
  StarWars:   { label: 'Star Wars',          description: 'Galaxy-wide factions and character palettes (Jedi, Sith, Mandalorians, Darth Vader, etc.)' },
  ...
  MechKeeb:   { label: 'Mechanical Keyboards', description: 'Popular mechanical keyboard keycap colorway designs (GMK, ePBT, etc.)' },
  IDE:        { label: 'IDE Themes',         description: 'Code editor and IDE theme-inspired palettes (Monokai, Dracula, Nord, Catppuccin, etc.)' },
};
