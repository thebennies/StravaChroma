 ...
 */
export function buildControls(container, { isMobile, onSliderChange, onPresetChange, onRandom, onReset, onSwap, onExport, onColorway, onBackgroundChange, onDropShadowChange, onLogoChange, initialBackground = 'auto', initialCustomImage = null, initialDropShadow = false, initialLogo = false, signal }) {
  container.innerHTML = '';
  ...
  if (isMobile) {
    return buildMobileTabs(container, { mapSection, dataSection, labelSection, onRandom, onReset, onSwap, onExport, onColorway, onBackgroundChange, initialBackground, initialCustomImage, onDropShadowChange, initialDropShadow, onLogoChange, initialLogo, signal });
  }

  // ── Desktop: all sections stacked ──────────────────────────────────────────

  const randomWrapper = buildActionsPanel(onRandom, onSwap, onReset, { onBackgroundChange, initialBackground, initialCustomImage, onDropShadowChange, initialDropShadow, onLogoChange, initialLogo });
...
function buildMobileTabs(container, { mapSection, dataSection, labelSection, onRandom, onReset, onSwap, onExport, onColorway, onBackgroundChange, initialBackground, initialCustomImage, onDropShadowChange, initialDropShadow, onLogoChange, initialLogo, signal }) {
  ...
  // Build panels
  const actionsPanel = buildActionsPanel(onRandom, onSwap, onReset, { onBackgroundChange, initialBackground, initialCustomImage, onDropShadowChange, initialDropShadow, onLogoChange, initialLogo });
...
function buildActionsPanel(onRandom, onSwap, onReset, { onBackgroundChange, initialBackground = 'auto', initialCustomImage = null, onDropShadowChange, initialDropShadow = false, onLogoChange, initialLogo = false } = {}) {
